...
namespace CosmosGettingStartedTutorial
{
    class Program
    {
        ...
        private static readonly string EndpointUri = "https://matejikcosmos.documents.azure.com:443/";
        // The primary key for the Azure Cosmos account.
        private static readonly string PrimaryKey = "De5aMYv1LoJB61wI4DfPpQVqTD9ieG7ZEW1ANmJtsMWs7jdSXfh2WEejnSCsz4Bz3IzyYwGITyQbjtdEorK0Sg==";
        ...
        public static async Task Main(string[] args)
        {
            try
            {
                ...
                await p.ReplaceFamilyItemAsync();
                await p.DeleteFamilyItemAsync();
